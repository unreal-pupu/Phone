...
import FIXHOME from '../assets/FIXHOME.jpg';
...
const Home = () => {
  ...
  <div className="flex flex-col space-y-4 w-full sm:w-1/2 mx-auto pt-40 sm:pl-24 lg:h-screen justify-center items-center">
    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-20 px-4 font-poppins text-blue-600 ">
      Fast Repairs, Amazing Deals, Seamless Swaps
    </h1>
    <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-center px-4 text-blue-950 font-poppins">
      Discover PHLOX, where we repair, sell, buy, and swap mobile phones and gadgets. Scan our code anytime, anywhere, and unlock exclusive services and deals!
    </p>
  </div>  
</div>
  </div>
  ...
  <h2 class="text-3xl font-bold text-center font-poppins mb-8">We Fix Everything!</h2>
  ...
  />
  <h3 className="text-xl font-bold text-gray-800 mt-4 font-poppins">
    iPHONE Repair
  </h3>
</div>
...
<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img
    ...
    className="w-32 h-40 object-cover mx-auto mt-4 rounded-md"
  />
  <h3 className="text-xl font-bold text-gray-800 mt-4 font-poppins">iPAD Repair</h3>
</div>
...
<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img
    ...
    className="w-32 h-40 object-cover mx-auto mt-4 rounded-md"
  />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">
    Tablet Repairs
  </h3>
</div>
...
<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  ...
  <div class="container mx-auto p-8">
    <div class="text-center mb-8">
      <h5 class="text-lg font-semibold text-gray-700 capitalize font-poppins">We Sell</h5>
    </div>
  ...
  <h3 className="text-xl font-bold text-gray-800 mt-4 font-poppins">iPHONES</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={PODS} alt="AirPods" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">AirPods</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={WWT} alt="Smart Watches" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">Smart Watches</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={PODSMAX} alt="AirPods Max" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">AirPods Max</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={STUDN} alt="Onyx Studio 9" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">Onyx Studio 9</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={CDBUY} alt="Optional Disc" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">Optional Disc</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={CNT} alt="Controller" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">Controller</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={PS} alt="Console & Controller" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">Console & Controller</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={GLASS} alt="Tempered Glass" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">Tempered Glass</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={WBAND} alt="Smartwatch Band" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">Smartwatch Band</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={POWERB} alt="Power Banks" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">Power Banks</h3>
</div>

<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  <img src={CASE} alt="Phone Case" className="w-32 h-40 object-cover mx-auto mt-4 rounded-md" />
  <h3 className="text-xl font-bold text-gray-800 mt-4 font-poppins">Phone Case</h3>
</div>
    </div>
  </div>
</div>
...
<div class="we-swap">
  <div class="container mx-auto p-8">
    <div class="text-center mb-8">
      <h5 class="text-lg font-semibold text-gray-700 capitalize font-poppins">We Swap</h5>
    </div>
  ...
  <h3 className="text-xl font-bold text-gray-800 mt-4 font-poppins">iPHONE</h3>
</div>
...
<div class="we-buy">
  <div class="container mx-auto p-8">
    <div class="text-center mb-8">
      <h5 class="text-lg font-semibold text-gray-700 capitalize font-poppins">We Buy</h5>
    </div>
...
<div className="bg-white p-6 rounded-lg shadow-lg text-center">
  ...
  <h3 className="text-xl font-bold text-gray-800 mt-4 capitalize font-poppins">Onyx Studio Speakers</h3>
</div>
    </div>
  </div>
</div>
...
<div class="container mx-auto px-4 pt-20">
  <h2 class="text-center text-2xl font-semibold mb-8 capitalize pb-12 font-poppins">common repairs and services</h2>
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    
    
    <div class="border-2 border-orange-500 p-6 flex flex-col justify-center items-center">
      <h5 class="text-lg font-bold font-poppins">Cracked Screen</h5>
    ...
    <div class="border-2 border-orange-500 p-6 flex flex-col justify-center items-center">
      <h5 class="text-lg font-bold font-poppins">Battery Issues</h5>
    ...
    <div class="border-2 border-orange-500 p-6 flex flex-col justify-center items-center">
      <h5 class="text-lg font-bold font-poppins">Charging Port Problems</h5>
    ...
    <div class="border-2 border-orange-500 p-6 flex flex-col justify-center items-center">
      <h5 class="text-lg font-bold font-poppins">Software Issues</h5>
    ...
    <div class="border-2 border-orange-500 p-6 flex flex-col justify-center items-center">
      <h5 class="text-lg font-bold font-poppins">Water Damage</h5>
    ...
    <div class="border-2 border-orange-500 p-6 flex flex-col justify-center items-center">
      <h5 class="text-lg font-bold font-poppins">Speaker/Audio Issues</h5>
  ...
  <h2 class="text-2xl font-semibold text-center text-gray-800 mb-4 font-poppins">Have a Question?</h2>
  <p class="text-center text-gray-600 mb-6 font-poppins">We are here to help! You can reach us through email or phone.</p>
  <div class="flex justify-center gap-12 flex-wrap">

  
    <div class="text-center bg-white p-6 rounded-lg shadow-lg w-64 mb-8 sm:mb-0">
      <h3 class="text-lg font-medium text-gray-800 mb-4 font-poppins">Email Us</h3>
    ...
    <div class="text-center bg-white p-6 rounded-lg shadow-lg w-64">
      <h3 class="text-lg font-medium text-gray-800 mb-4 font-poppins">Call Us</h3>
      <p class="text-gray-600 mb-4 font-poppins">Prefer to talk to us directly? Give us a call.</p>
      <a href="tel:+1234567890" class="inline-block text-blue-500 hover:text-blue-700">+1 (234) 567-890</a>
    </div>
  </div>
</div>
